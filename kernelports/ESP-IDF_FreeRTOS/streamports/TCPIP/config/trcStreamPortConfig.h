 ...
 *
 * @brief Defines the TCP port
 */
#ifdef CONFIG_PERCEPIO_TRC_CFG_STREAM_PORT_TCPIP_PORT
#define TRC_CFG_STREAM_PORT_TCPIP_PORT CONFIG_PERCEPIO_TRC_CFG_STREAM_PORT_TCPIP_PORT
#else
#define TRC_CFG_STREAM_PORT_TCPIP_PORT "18419"
#endif
